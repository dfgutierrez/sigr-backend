...
public class VehiculoController {
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('ADMINISTRADOR') or hasRole('VENDEDOR')")
    ...
    @org.springframework.security.access.prepost.PreAuthorize("hasRole('ADMINISTRADOR') or hasRole('VENDEDOR') or hasRole('SUPERVISOR')")
